        ...
        <WLayout>
            ...
            <WMMain>
                <div style={{ display: "flex", alignItems: "center", width: "100%", height: "800px", border: "5px solid red"}}>
                    ...
                    <div>
                        <div style={{marginLeft: "350px", width: "500px", height: "550px", border: "5px solid black", color: "white"}}>
                        ...
                        <div style={{marginLeft: "350px", width: "500px", height: "50px", border: "5px solid black", color: "white"}}>
